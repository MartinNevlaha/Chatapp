...
export const CLEAN_UP_MESSAGES = "CLEAN_UP_MESSAGES";
...
export const IMAGE_UPLOAD_SUCCESS = "IMAGE_CHAT_UPLOAD_SUCCESS";
export const IMAGE_UPLOAD_PROGRESS = "IMAGE_UPLOAD_PROGRESS";
export const IMAGE_UPLOAD_FAILED = "IMAGE_UPLOAD_FAILED";

export const SEE_NEW_MESSAGE_SUCCESS = "SEE_NEW_MESSAGE_SUCCESS";
export const USER_IS_TYPING = "USER_IS_TYPING";
export const MUTE_CHAT_SOUND = "MUTE_CHAT_SOUND";
...
export const CALL_TO_FRIEND = "CALL_TO_FRIEND";
export const CALL_ACCEPTED = "CALL_ACCEPTED";
export const FRIEND_CALLING = "FRIEND_CALLING";
export const CALL_REJECT = "CALL_REJECT";
export const CALL_REJECT_RECIPIENT = "CALL_REJECT_RECIPIENT";